...
from imagenet100_data import build_imagenet100_datasets
...
def main():
    ...
    data_root, train_set, val_set, num_classes = build_imagenet100_datasets(
        args.data_root,
        tf_train,
        tf_val,
    )
    ...
    if args.probe_init_batch_loss:
        out_path = run_classification_probe(
            args=args,
            prefix="resnet50_imagenet100",
            case_id="resnet50_imagenet100",
            label="ResNet50 + ImageNet100",
            split="train",
            family="vision",
    ...
    print("ImageNet100 root:", data_root)
